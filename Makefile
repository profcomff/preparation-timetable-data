...
format:
	source ./venv/bin/activate && autoflake -r --in-place --remove-all-unused-imports ./profcomff_parse_lib
	source ./venv/bin/activate && isort ./profcomff_parse_lib
	source ./venv/bin/activate && black ./profcomff_parse_lib
